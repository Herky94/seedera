...
function ProjectCard({ project, index }: { project: Project; index: number }) {
  ...
  return (
    ...
    >
      ...
      <div
        className="relative overflow-hidden rounded-[10px] cursor-none group"
      ...
      >
        <img
          src={project.image}
          alt={project.client}
          className="project-img absolute inset-0 w-full h-full object-cover transition-transform duration-700 ease-out scale-[1.15] group-hover:scale-100 will-change-transform"
        />
      </div>
